...
for dir in $SNAPCRAFT_PART_INSTALL/usr/share/icons/*/; do
  ...
  build(appOutDir, arch) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const args = ["snap", "--app", appOutDir, "--stage", stageDir, "--arch", (0, _builderUtil().toLinuxArchString)(arch), "--output", artifactPath, "--docker-image", "electronuserland/builder:latest"];
      ...
      yield (0, _fsExtraP().writeFile)(commandWrapperFile, `#!/bin/bash\nexec $SNAP/bin/desktop-launch "$SNAP/app/${_this.packager.executableName}"`);
