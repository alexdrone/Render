...
class PkgTarget extends _core().Target {
  ...
  build(appPath, arch) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const identity = (yield Promise.all([(0, _codeSign().findIdentity)(certType, options.identity || packager.platformSpecificBuildOptions.identity, keychainName), _this.customizeDistributionConfiguration(distInfoFile, appPath), _this.buildComponentPackage(appPath, innerPackageFile)]))[0];
  ...
  customizeDistributionConfiguration(distInfoFile, appPath) {
    ...
    return (0, _bluebirdLst().coroutine)(function* () {
      ...
      const license = yield (0, _license().getNotLocalizedLicenseFiles)(options.license, _this2.packager);
