...
let modifyMainPackageJson = (() => {
  var _ref = (0, _bluebirdLst().coroutine)(function* (file, extraMetadata, isRemovePackageScripts) {
    const mainPackageData = JSON.parse((yield (0, _fsExtraP().readFile)(file, "utf-8")));
