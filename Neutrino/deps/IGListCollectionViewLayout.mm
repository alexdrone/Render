...
- (void)cacheLayout {
  ...
  const NSInteger sectionCount = 1;
  const UIEdgeInsets contentInset = collectionView.contentInset;
  ...
  for (NSInteger section = 0; section < sectionCount; section++) {
    ...
    const CGSize headerSize = CGSizeZero;
    const UIEdgeInsets insets = UIEdgeInsetsZero;
    const CGFloat lineSpacing = 0;
    const CGFloat interitemSpacing = 0;
