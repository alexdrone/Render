...
#   define  YAML_DECLARE(type)  type
  ...
  /**
   * @defgroup styles YAMLNode Styles
   * @{
   */
...
#define YAML_DEFAULT_MAPPING_TAG    YAML_MAP_TAG
  ...
  /**
   * @defgroup parser YAMLParser Definitions
   * @{
   */
  ...
  /**
   * @defgroup emitter YAMLEmitter Definitions
   * @{
   */
