...
struct Typography {
  static let big = UIFont.systemFont(ofSize: 36.0, weight: UIFont.Weight.bold)
  static let mediumBold = UIFont.systemFont(ofSize: 18.0, weight: UIFont.Weight.bold)
  static let small = UIFont.systemFont(ofSize: 12.0, weight: UIFont.Weight.regular)
  static let smallBold = UIFont.systemFont(ofSize: 12.0, weight: UIFont.Weight.bold)
  static let smallLight = UIFont.systemFont(ofSize: 12.0, weight: UIFont.Weight.light)
  static let extraSmallLight = UIFont.systemFont(ofSize: 10.0, weight: UIFont.Weight.light)
}
